...
const Speedometer = ({
  ...
  const percentElement = showPercent ? (
    <Text
      style={[{ backgroundColor: innerColor }, percentStyle]}
      numberOfLines={1}
    >
      {percentValue}%
    </Text>
  ...
  const textElement =
    showText && text ? (
      <Text
        style={[{ backgroundColor: innerColor }, textStyle]}
        numberOfLines={1}
      >
        {text}
      </Text>
  ...
  const labelsElement = showLabels ? (
    <View style={[styles.labelsView, { width: size }]}>
      <Text style={[styles.initialLabel, labelStyle]} numberOfLines={1}>
        0
      </Text>
      <Text style={[styles.finalLabel, labelStyle]} numberOfLines={1}>
        {totalValue}
      </Text>
    </View>
  ) : null;
  ...
  return (
    ...
    >
      <View
        style={[
          styles.outerCircle,
          { backgroundColor: outerColor, flexGrow: 0 },
        ]}
      >
        <LinearGradient
          colors={colorArry}
